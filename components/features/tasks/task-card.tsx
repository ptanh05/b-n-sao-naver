...
import { getCategoryById } from "@/lib/task-categories"
    ...
    >
      ...
      <CardContent className="pt-0">
        <div className="flex flex-wrap gap-2 mb-3">
          {task.category && (
            <Badge variant="outline" className={getCategoryById(task.category).color}>
              {getCategoryById(task.category).icon} {getCategoryById(task.category).name}
            </Badge>
          )}
